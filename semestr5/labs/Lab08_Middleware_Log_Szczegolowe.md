# Lab08 Middleware Log — szczegółowe laboratorium
...
## Cel
- Zbudować od zera usługę **Minimal API** pokrywając temat: Serilog/ILogger, pipeline.
...
```pwsh
mkdir Lab08_Middleware_Log; cd Lab08_Middleware_Log
dotnet new webapi -n Api --use-minimal-apis -f net9.0
dotnet new xunit -n Api.Tests -f net9.0
dotnet sln new Lab08_Middleware_Log.sln
