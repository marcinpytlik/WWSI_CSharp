...
- Stosować kluczowe elementy tematu: xUnit: Asserts, AAA pattern, test-first mini kata.
...
1. Utwórz katalog labu:  
   ```pwsh
   mkdir Lab10_Testowanie; cd Lab10_Testowanie
   git init
   ```
2. Stwórz projekt konsolowy i testy xUnit:  
   ...
   dotnet sln new Lab10_Testowanie.sln
...
dotnet clean
git add .
git commit -m "Finish Lab10 Testowanie"
```
