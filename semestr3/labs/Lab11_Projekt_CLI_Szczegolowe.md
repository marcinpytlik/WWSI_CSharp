# Lab11 Projekt CLI — szczegółowe laboratorium
...
- Stosować kluczowe elementy tematu: projekt CLI (kalkulator lub notatnik), plan klas i testów.
...
1. Utwórz katalog labu:  
   ```pwsh
   mkdir Lab11_Projekt_CLI; cd Lab11_Projekt_CLI
   git init
   ```
2. Stwórz projekt konsolowy i testy xUnit:  
   ...
   dotnet sln new Lab11_Projekt_CLI.sln
...
dotnet clean
git add .
git commit -m "Finish Lab11 Projekt CLI"
```
