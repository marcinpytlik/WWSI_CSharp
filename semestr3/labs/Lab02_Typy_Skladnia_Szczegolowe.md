# Lab02 Typy Skladnia — szczegółowe laboratorium
...
- Stosować kluczowe elementy tematu: Typy proste, konwersje, String interpolation, Operatory porównań.
...
1. Utwórz katalog labu:  
   ```pwsh
   mkdir Lab02_Typy_Skladnia; cd Lab02_Typy_Skladnia
   git init
   ```
2. Stwórz projekt konsolowy i testy xUnit:  
   ...
   dotnet sln new Lab02_Typy_Skladnia.sln
...
dotnet clean
git add .
git commit -m "Finish Lab02 Typy Skladnia"
```
