...
- Stosować kluczowe elementy tematu: List/Dictionary/HashSet, scenariusze wydajności.
...
1. Utwórz katalog labu:  
   ```pwsh
   mkdir Lab08_Kolekcje; cd Lab08_Kolekcje
   git init
   ```
2. Stwórz projekt konsolowy i testy xUnit:  
   ...
   dotnet sln new Lab08_Kolekcje.sln
...
dotnet clean
git add .
git commit -m "Finish Lab08 Kolekcje"
```
