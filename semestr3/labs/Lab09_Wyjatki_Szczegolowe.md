# Lab09 Wyjatki — szczegółowe laboratorium
...
- Stosować kluczowe elementy tematu: try/catch/finally, własne wyjątki, kiedy nie łapać.
...
1. Utwórz katalog labu:  
   ```pwsh
   mkdir Lab09_Wyjatki; cd Lab09_Wyjatki
   git init
   ```
2. Stwórz projekt konsolowy i testy xUnit:  
   ...
   dotnet sln new Lab09_Wyjatki.sln
...
dotnet clean
git add .
git commit -m "Finish Lab09 Wyjatki"
```
